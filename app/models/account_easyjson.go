...
func easyjson349b126bDecodeHlcAppModels(in *jlexer.Lexer, out *Premium) {
...
func easyjson349b126bEncodeHlcAppModels(out *jwriter.Writer, in Premium) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Start != 0 {
...
func (v Premium) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson349b126bEncodeHlcAppModels(&w, v)
...
func (v *Premium) UnmarshalJSON(data []byte) error {
	...
	easyjson349b126bDecodeHlcAppModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Premium) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson349b126bDecodeHlcAppModels(l, v)
}
func easyjson349b126bDecodeHlcAppModels1(in *jlexer.Lexer, out *Like) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson349b126bEncodeHlcAppModels1(out *jwriter.Writer, in Like) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != 0 {
...
func (v Like) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson349b126bEncodeHlcAppModels1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Like) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson349b126bDecodeHlcAppModels1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Like) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson349b126bDecodeHlcAppModels1(l, v)
}
func easyjson349b126bDecodeHlcAppModels2(in *jlexer.Lexer, out *Accounts) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson349b126bEncodeHlcAppModels2(out *jwriter.Writer, in Accounts) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Accounts) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson349b126bEncodeHlcAppModels2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Accounts) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson349b126bDecodeHlcAppModels2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Accounts) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson349b126bDecodeHlcAppModels2(l, v)
}
func easyjson349b126bDecodeHlcAppModels3(in *jlexer.Lexer, out *Account) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson349b126bEncodeHlcAppModels3(out *jwriter.Writer, in Account) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != 0 {
...
func (v Account) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson349b126bEncodeHlcAppModels3(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Account) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson349b126bDecodeHlcAppModels3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Account) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson349b126bDecodeHlcAppModels3(l, v)
}
